...
const Product = class Product {
    constructor(inputString) {
      ...
      const [nameStr, priceStr, availabilityStr] = inputStrArray
      this.name = nameStr;
      this.price = parseFloat(priceStr);
      this.availability = availabilityStr;
    }
    ...
    static printProducts(products) {
      ...
      products.forEach(product => {
        ...
        console.log(`Product: ${product.name}, Cost: ${formatter.format(product.price)}, Availability: ${availability}`);
      });
    }
  };
